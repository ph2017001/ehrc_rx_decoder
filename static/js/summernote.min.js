    ...
    var X = function(a) {
        ...
        da = function(b) {
            var e = this,
                ...
                k = this.representShortcut = function(a) {
                    var b = j[a];
                    return m.isMac && (b = b.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")), b = b.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]"), " (" + b + ")"
                };
            this.initialize = function() {
        ...
        ka = function(b) {
            ...
            this.createShortCutList = function() {
                ...
                var b = f.dialogsInBody ? a(document.body) : e,
                    c = ['<p class="text-center">', '<a href="//summernote.org/" target="_blank">Summernote 0.8.1</a> Â· ', '<a href="//github.com/summernote/summernote" target="_blank">Project</a> Â· ', '<a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
                this.$dialog = d.dialog({
